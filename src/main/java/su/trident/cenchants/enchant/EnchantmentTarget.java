...
public enum EnchantmentTarget
{
    ...
    WEAPON(Arrays.asList(Material.WOODEN_SWORD, Material.STONE_SWORD, Material.IRON_SWORD, Material.GOLDEN_SWORD, Material.DIAMOND_SWORD, Material.NETHERITE_SWORD, Material.ENCHANTED_BOOK, Material.TRIDENT)),
    ...
    EnchantmentTarget(List<Material> targetItems)
    {
    ...
    public boolean isTarget(ItemStack stack) {
        return this.targetItems.contains(stack.getType());
    }
}
